...
public class TKdate
{
   ...
   public TKdate(int m, int d, int y)
   {   
      month = m;
      day = d;
      year = y;
   ...
   public TKdate(String dateString)
   {   
   ...
   public int julianDate()
   {
      ...
      TKdate tempDate = new TKdate(this.getMonth(),this.getDay(),this.getYear());        
   ...
   // The method assumes a valid date.
   public int weekDay()
   {        
        int DayCnt;
        int daynum,i;
