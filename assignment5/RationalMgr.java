 ...
 * This application provides a dialog-based user
 * interface for basic fraction manipulation
 * 
 */
   ...
   public static void handleMenuChoice(char choice)
   {
      ...
      switch (choice)
      {
         ...
         case '4': JOptionPane.showMessageDialog(null, 
                   ...
                   break;
         case '5': newFact = Integer.parseInt(
                       JOptionPane.showInputDialog(null, 
                       "Enter New Factor"));
                   aFraction.elevate(newFact);
                   break;
